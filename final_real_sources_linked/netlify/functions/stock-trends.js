...
// 白名單（可再擴充）
const WHITELIST = [
  '台積電','聯發科','鴻海','廣達','緯創','技嘉','英業達','仁寶','華碩','宏碁','創意','世芯','聯詠','聯電','日月光','南亞科',
  '台股','加權指數','櫃買','半導體','AI概念股','AI伺服器','AI','通膨','降息','升息','聯準會','FED','外資','投信','自營商',
  '融資','融券','獲利','營收','財報','除權息','除息','合併','重組','電動車','5G','光電股','傳產股','金融股','生技股','觀光股',
  '航運股','塑化股','鋼鐵股','紡織股','營建股','通訊股','半導體股','車用電子','矽智財','高股息','ETF','0050','0056','00929','00940'
];
